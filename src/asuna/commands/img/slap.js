...
class Slap extends Command {
    ...
    async slash(inter){
        ...
        if(inter.data.options[0].value == this.client.user.id) return inter.createMessage("Oi you little shit!");
        if(inter.data.options[0].value == inter.member.id) return inter.createMessage('Don\'t slap yourself idiot!')
